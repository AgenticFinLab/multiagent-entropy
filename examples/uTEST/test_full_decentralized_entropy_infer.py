"""
Executable test script for Orchestrator Repeat (looping sequential + aggregator) agent.
...
- Run: `python examples/uTEST/test_full_decentralized_entropy_infer.py -c configs/uTEST/full_decentralized_entropy_infer.yml`
"""
...
def main():
    """A demo to test the OrchestratorFullDecentralized with a YAML config file."""
    load_dotenv()
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="configs/uTEST/full_decentralized_entropy_infer.yml",
    ...
    agent = OrchestratorFullDecentralized(run_config=run_config)
    ...
    for start_idx in range(0, total_samples, batch_size):
        ...
        # (Though usually it only runs once at the end)
