...
class DataLoader:
    ...
    def load_experiment_config(self, experiment_name: str) -> Dict[str, Any]:
        ...
        if not config_file.exists():
            ...
            if config_file is None:
                raise FileNotFoundError(f"Config file not found for experiment: {experiment_name}")
    ...
    def load_result_store_info(self, dataset: str, experiment_name: str) -> Dict[str, Any]:
    ...
    def load_result_block(self, dataset: str, experiment_name: str, block_name: str) -> Dict[str, Any]:
        traces_path = self.results_path / dataset.lower() / experiment_name / "traces"
    ...
    def load_entropy_tensor(self, dataset: str, experiment_name: str, result_id: str) -> Optional[torch.Tensor]:
        traces_path = self.results_path / dataset.lower() / experiment_name / "traces"
