...
class ExperimentAnalyzer:
    ...
    def analyze_experiment(
        ...
        metrics["summary"] = self._calculate_summary(metrics["samples"], agent_architecture)
    ...
    def _analyze_sample(
        ...
        for result_info in sample_results:
            ...
            entropy_tensor = self.data_loader.load_entropy_tensor(dataset, experiment_name, result_id)
            avg_entropy = self.metrics_calculator.calculate_average_entropy(entropy_tensor)
            ...
            if "final_answer" in result_data:
                ...
                predicted_answer = self.metrics_calculator.extract_boxed_answer(response)
    ...
    def compare_experiments(
        ...
        for exp_name, metrics in all_metrics["experiments"].items():
            ...
            comparison["architectures"][arch].append({
                ...
                "format_compliance_rate": metrics["summary"]["format_compliance_rate"],
