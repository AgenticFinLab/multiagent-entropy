...
class OrchestratorDecentralized(OrchestratorCentralized):
    ...
    def execute_sub_agent(self, state: AgentState, name: str) -> AgentState:
        """
        Execute a single layer1 agent, incorporating context from the previous round's Orchestrator and agents.
        """
        ...
        for i in range(num_samples):
            ...
            # 1. Build context from previous round's agents and Orchestrator.
            prev_context = ""
